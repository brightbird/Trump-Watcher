...
2. Install dependencies:
   ...
   ```
3. (Optional) Copy `assets/config_template.json` to the project root as `config.json` and customize settings
...
Copy `assets/config_template.json` to the project root as `config.json`:
